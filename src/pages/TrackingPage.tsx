  ...
  const handleTrackShipment = async (number: string) => {
    try {
      ...
      const normalizedShipment = {
        ...
        packageDescription: shipment.package_description || 'Package',
        description: shipment.package_description || 'Package',
        package_description: shipment.package_description || 'Package',
